...
<meta charset="ISO-8859-1">
 ...
 <spring:url value="/MantenedorUsuario/guardar" var="urlGuardarUsuario"/>
...
<h1 class="h3 mb-1 text-gray-800">Nueva Region</h1>
					...
					<p class="mb-4">
						<br />
						<div>Ingrese los datos del nuevo registro de Usuario</div>
						<br /> <br />
						
						
					</p>

					<form class="user" action="${urlGuardarUsuario}" method="post">

						<div class="form-group row">
							<div class="col-3">
								<label>ID:</label>
								<input name="usuarioID" id="usuarioID" type="number" required class="form-control form-control-user" >

							</div>
							<div class="col-3">
								<label>Nombre de Usuario:</label>
								<input name="nombreu" id="nombreu" type="text" required class="form-control form-control-user" >
							</div>
						</div>
